export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'Thêm tối đa 5 hình ảnh để hiển thị trong phần xem trước portfolio',
      validation: Rule => Rule.max(5).error('Chỉ được thêm tối đa 5 hình ảnh xem trước'),
      group: 'images',
      options: {
        layout: 'grid'
      }
