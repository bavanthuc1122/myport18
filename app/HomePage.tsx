    ...
    >
      <div className="bg-black text-white min-h-screen">
        ...
        <div className="relative z-10">
                ...
                heroData?.videoFile?.url ? (
                  ...
                  <>
                    ...
                    <video
                      ...
                      style={{ zIndex: 1 }}
                    />
                    <div className="video-container" onClick={() => console.log('Hero Video URL:', heroData.videoFile.url)}>
                      <video
                        autoPlay
                        muted
                        loop
                      ...
                      >
                        <source src={heroData.videoFile.url} type="video/mp4" />
          ...
          {/* Gallery Highlights section has been removed */}
