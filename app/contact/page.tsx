              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="mb-12">
                    ...
                    <p className="text-gray-400 text-lg">For Photography</p>
                  </div>

                  {/* Contact info */}
                  <div className="space-y-6 mb-12">
                    <h2 className="text-2xl font-light">Thức ( Photographer )</h2>
                    <div className="space-y-2">
                      <p className="text-gray-400">thucnhthuc@gmail.com</p>
                      <p className="text-gray-400">(+84) 0814019555</p>
                    </div>
                  </div>
