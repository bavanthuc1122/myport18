export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'Thêm tối đa 7 hình ảnh để hiển thị trong Portfolio Showcase và rail trượt ngang',
      validation: Rule => Rule.max(7).error('Chỉ được thêm tối đa 7 hình ảnh xem trước'),
      group: 'images',
      options: {
        layout: 'grid'
      }
